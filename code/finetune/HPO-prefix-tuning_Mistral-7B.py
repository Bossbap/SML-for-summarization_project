...
def objective(trial: optuna.trial.Trial):
    ...
    num_virtual_tokens = trial.suggest_int("num_virtual_tokens", 20, 50)
...
with open("hyper-parameter_config_prefix_Mistral-7B.json", "w") as f:
    json.dump(trial.params, f, indent=4)

print("Best parameters saved to hyper-parameter_config_prefix_Mistral-7B.json")